...
debug: dirs
	$(MAKE) -C $(SRC_DIR)/apps BUILD_CONFIG=debug

#	$(MAKE) -C $(SRC_DIR) BUILD_CONFIG=release
release: dirs
	$(MAKE) -C $(SRC_DIR)/apps BUILD_CONFIG=release
...
tidy: dirs
	...
	$(MAKE) -C $(SRC_DIR)/apps tidy

clean: dirs
	$(MAKE) -C $(SRC_DIR) clean
	$(MAKE) -C $(SRC_DIR)/tests clean
	$(MAKE) -C $(SRC_DIR)/apps clean
